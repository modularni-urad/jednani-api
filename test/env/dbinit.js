...
export default async function initDB (migrationsDir) {
  ...
  // knexHooks(knex)
  // knex.addHook('before', 'insert', TNAMES.TASKS, (when, method, table, params) => {
  ...
  // knex.addHook('before', 'update', TNAMES.TASKS, (when, method, table, params) => {
  ...
  //   })
  // }
  // knex.addHook('after', 'select', TNAMES.TASKS, (when, method, table, params) => {
